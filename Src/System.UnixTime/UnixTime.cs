...
namespace System
{
...
#endif
	{
		...
		public override bool Equals(object obj)
		{
			...
			{
				returnValue = time.Timestamp == this.Timestamp;
			}
		...
		public static DateTime ToUniversalDateTime(long value)
		{
			...
			//
			returnValue = UnixTime.Epoch.Add(TimeSpan.FromSeconds(value));
		...
		public static DateTime ToLocalDateTime(long value)
		{
			...
			// DateTime = Epoch + UNIX.TS
			//
			returnValue = UnixTime.Epoch.Add(TimeSpan.FromSeconds(value)).ToLocalTime();
